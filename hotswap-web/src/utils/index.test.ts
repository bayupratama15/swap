...
import { TokenAmount, Token, ChainId, Percent, JSBI } from '@hotswapbsc/hotswap-sdk'
...
describe('utils', () => {
  ...
  describe('#calculateSlippageAmount', () => {
    it('bounds are correct', () => {
      const tokenAmount = new TokenAmount(new Token(ChainId.BSCMAINNET, AddressZero, 0), '100')
