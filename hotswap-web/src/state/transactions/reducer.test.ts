...
describe('transaction reducer', () => {
  ...
  describe('addTransaction', () => {
    it('adds the transaction', () => {
      ...
      expect(txs[ChainId.BSCMAINNET]).toBeTruthy()
      expect(txs[ChainId.BSCMAINNET]?.['0x0']).toBeTruthy()
      const tx = txs[ChainId.BSCMAINNET]?.['0x0']
  ...
  describe('clearAllTransactions', () => {
    it('removes all transactions for the chain', () => {
      ...
      expect(Object.keys(store.getState())).toEqual([String(ChainId.BSCMAINNET), String(ChainId.RINKEBY)])
      expect(Object.keys(store.getState()[ChainId.BSCMAINNET] ?? {})).toEqual(['0x0'])
      expect(Object.keys(store.getState()[ChainId.RINKEBY] ?? {})).toEqual(['0x1'])
      store.dispatch(clearAllTransactions({ chainId: ChainId.BSCMAINNET }))
      expect(Object.keys(store.getState())).toHaveLength(2)
      expect(Object.keys(store.getState())).toEqual([String(ChainId.BSCMAINNET), String(ChainId.RINKEBY)])
      expect(Object.keys(store.getState()[ChainId.BSCMAINNET] ?? {})).toEqual([])
      expect(Object.keys(store.getState()[ChainId.RINKEBY] ?? {})).toEqual(['0x1'])
    })
  })
})
