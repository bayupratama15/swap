...
export default function Menu() {
  ...
  return (
    ...
    <StyledMenu ref={node as any}>
      ...
      {open && (
        <MenuFlyout>
          <MenuItem id="link" href={CODE_LINK} rel="noopener noreferrer">
            <Code size={14} />
            Code (Soon)
          </MenuItem>
          <MenuItem id="link" href="#" rel="noopener noreferrer">
            <MessageCircle size={14} />
            <TranslatedText translationId={34}>Telegram</TranslatedText>
          </MenuItem>
          <MenuItem id="link" href="https://t.me/Eight_Box" rel="noopener noreferrer">
            <PieChart size={14} />
            Analytics(Soon)
          </MenuItem>
        </MenuFlyout>
